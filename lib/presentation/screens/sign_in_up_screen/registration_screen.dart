                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (_registrationFormKey.currentState!.saveAndValidate()) {
                              ...
                              BlocProvider.of<UnAuthWrapperCubit>(context).goToBasicInfo(registrationData: _registrationFormKey.currentState!.value);
                            }
                          },
                        ),
                      ),
                      ...
                      DashedButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<UnAuthWrapperCubit>(context).goToLogin();
                          },
                          dashLineRadius: 16),
                    ],
                  ),
