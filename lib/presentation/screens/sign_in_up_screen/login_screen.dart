...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<UnAuthWrapperCubit, UnAuthWrapperState>(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomElevatedButton(
                          buttonText: 'LOGIN',
                          isLoading: (state is OnLoginScreen && state.screenStatus == ScreenStatus.loading),
                          onPressed: () async {
                            if (_loginFormKey.currentState!.saveAndValidate()) {
                              logger.i('Form is valid');
                              context.read<UnAuthWrapperCubit>().login(
                      ...
                      DashedButton(
                        ...
                        onPressed: () {
                          BlocProvider.of<UnAuthWrapperCubit>(context).goToRegistation();
                        },
                        dashLineRadius: 16,
                      ),
                    ],
