...
class AddQualificationButton extends StatelessWidget {
  ...
  AddQualificationButton({Key? key, required this.onAdd}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<AddQualificationButtonCubit>(
      create: (context) => AddQualificationButtonCubit(buttonHeight: 54, isExpanded: false, showContainers: false, isEditing: false, context: context),
                                ...
                                child: CustomElevatedButton(
                                  ...
                                  onPressed: () {
                                    if (qualificationFormKey.currentState!.saveAndValidate()) {
                                      ...
                                      BlocProvider.of<AddQualificationButtonCubit>(context).collapse();
                                    }
                                  },
                                  // },
                                ),
